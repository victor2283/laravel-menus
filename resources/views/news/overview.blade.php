					...
					<div class="p-r-45 p-r-0-lg">
						...
						<div class="p-b-63">
							...
							<div class="p-t-32">
														...
														@php foreach ($datos['news'] as $news_item): @endphp
									...
									<a href="blog-detail" class="ltext-108 cl2 hov-cl1 trans-04">
                                                                                @php echo  $news_item->title @endphp 
                                                                        </a>
								</h4>


                                                                <div class="main">
                                                                        @php echo $news_item->body @endphp 
                                                                </div>
									...
									<span class="flex-w flex-m stext-111 cl2 p-r-30 m-tb-10">
										...
										<span>
											8 Comments
                                                                        ...
                                                                        <a href="{{route('news_slug.slug', ['news_slug' => $news_item->slug])}}" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
                            ...
                            @php else : @endphp
                                                        ...
                                                        <p>No se ha podido encontrar ningun articulo para usted.</p>
